...
STRINGS = {
    "en": {
        ...
        "comment.coverage": "⚠️ **Partial review: {warning}** — the findings below do NOT cover the dropped files. "
                            "Split the PR or raise the token budget before trusting a clean result.",
    ...
    "zh": {
        ...
        "comment.coverage": "⚠️ **部分审查：{warning}** —— 以下发现未覆盖被丢弃的文件，"
                            "请拆分 PR 或提高 token 预算后再信任无问题结论。",
